...
perde(1) :-
    write('primeira perda de vida PERDE 1.'), nl.
	
perde(101) :-
	write('segunda perda de vida PERDE 1.'), nl.

perde(201) :-
	write('terceira perda de vida PERDE 1.'), nl.
	
	


perde(2) :-
    write('primeira perda de vida PERDE 2.'), nl.
	
perde(102) :-
	write('segunda perda de vida PERDE 2.'), nl.

perde(202) :-
	write('terceira perda de vida PERDE 2.'), nl.
	
	
	
perde(3) :-
    write('primeira perda de vida PERDE 3.'), nl.
	
perde(103) :-
	write('segunda perda de vida PERDE 3.'), nl.

perde(203) :-
	write('terceira perda de vida PERDE 3.'), nl.
...
vidas(Y, V, K, Classe) :-
    ...
    (
    	X = 'godmode' ->  write('godmode ativado, avançando para próxima fase...'), nl;
