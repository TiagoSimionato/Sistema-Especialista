...
perde(1) :-
    write('a temperatura da sala aumentou, fazendo com que você perdesse uma vida'), nl.
...
classes(Classe) :-
	...
	write('Cientista: Mestre da experimentação (Recebe uma dica extra por fase).'), nl,
	write('Ciborgue : Consegue enxergar mais do que os olhos podem ver (mais opções de caminhos).'), nl,
